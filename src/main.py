...
@click.argument('net_name', type=click.Choice(['mnist_LeNet', 'cifar10_LeNet', 'cifar10_LeNet_ELU', 'mine_net2', 'mine_net3', 'mine_net4', 'mine_net5', 'mine_sp', 'mine_net1D', 'mine_netRC2D','mine_netBuffer4D','mine_netBuffer10D']))
